...
namespace CalcOne
{
    public class Util
    {
        ...
        private void Process(string op)
        {
            ...
            switch (op)
            {
                ...
                case "GCF":
                    ...
                    break;
                case "H":
                    string strHex = Convert.ToInt64(Clamp64(First)).ToString("X");
                    Console.WriteLine("HEX({0}) = {1}", First, strHex);
                    break;
                case "HD":
                    Console.Write("Hex? ");
                    input = Console.ReadLine();
                    result = int.Parse(input.Trim(), System.Globalization.NumberStyles.HexNumber);
                ...
                case "P2":
                    ...
                    break;
                case "PD":
                    result = PrimeDivisor(Clamp(First));
                ...
                case "PI":
                    ...
                    break;
                case "PM":
                    bool prime = IsPrime(Clamp(First));
        ...
        // Clamp64.
        // Return Int64.
        private static long Clamp64(double x)
        {
